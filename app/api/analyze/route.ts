...
const DEFAULT_STORY_PROMPTS: Record<string, string> = {
  ...
  'social-circle': 'You are a genealogy researcher and social historian. Based on the newspaper clipping transcription and clue report provided, explore the social circle surrounding this ancestor. Who are the people named — family, friends, neighbors, colleagues, community figures? What organizations, institutions, or groups appear? What does this network reveal about your ancestor\'s place in their community? This story is especially powerful for obituaries, wedding announcements, court notices, society columns, and local event coverage.',
}
